...
The remainder of this paper is structured as follows. @sec-data provides details on the data source, including the specific variables used, and describes the data cleaning process to prepare for analysis. Data tools and methodologies applied in this paper are also stated in this section. Measurement and ethics are considered as well. @sec-results presents the key results, focusing on occupancy rates, service user counts, and actual capacity over time; Visualizations are used to intuitively convey these findings. @sec-dis offers a discussion of the results and their implications,also emphasizing the importance of balancing shelter occupancy and capacity for effective service provision while limitations point out some weakness in this paper. The comprehensive structure ensures that the reader gains a full understanding of what was analyzed, the findings, and their significance.
